    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">ویرایش امتحان</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">خانه</a></li>
                            <li class="breadcrumb-item active">ویرایش امتحان</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ویرایش امتحان</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('quiz.update', [$quiz->id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('university') is-invalid @enderror"
                                                        ...
                                                        @if($university)
                                                            @if($quiz->university == 'null')
                                                                <option value="null">بدون دانشگاه</option>
                                                            @endif
                                                            @foreach($university as $item)
                                                                <option value="{{$item->name}}" @if($item->name == $quiz->university) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        @else
                                                            @if($quiz->university == 'null')
                                                                <option value="null">بدون دانشگاه</option>
                                                    ...
                                                    <select class="form-control @error('university') is-invalid @enderror"
                                                        ...
                                                        @if($major)
                                                            ...
                                                            @foreach($major as $item)
                                                                <option value="{{$item->name}}" @if($item->name == $quiz->major) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        @else
                                                            @if($quiz->major == 'null')
                                                                <option value="null">بدون رشته</option>
                                                    ...
                                                    <select class="form-control @error('university') is-invalid @enderror"
                                                        ...
                                                        @if($section)
                                                            ...
                                                            @foreach($section as $item)
                                                                <option value="{{$item->name}}" @if($item->name == $quiz->section) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        @else
                                                            @if($quiz->section == 'null')
                                                                <option value="null">بدون مقطع</option>
                                                    ...
                                                    <select class="form-control @error('university') is-invalid @enderror"
                                                        ...
                                                        @if($term)
                                                            ...
                                                            @foreach($term as $item)
                                                                <option value="{{$item->name}}" @if($item->name == $quiz->term) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        @else
                                                            @if($quiz->term == 'null')
                                                                <option value="null">بدون ترم</option>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="contact-platform" class="form-control @error('date') is-invalid @enderror"
                                                           name="date" value="{{$quiz->date}}" required>
                                                </div>
                                                @error('date')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="contact-platform" class="form-control @error('collegians') is-invalid @enderror"
                                                           name="collegians" value="{{$quiz->collegians}}" required>
                                                </div>
                                                @error('collegians')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <ul class="list-unstyled mb-2">
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="status" @if($quiz->status == 'برگزار شده') checked @endif value="برگزار شده">
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="status" @if($quiz->status == 'در انتظار برگزاری') checked @endif value="در انتظار برگزاری">
                                                                <span class="vs-radio vs-radio-lg">
                                                                    <span class="vs-radio--border"></span>
                                                                    <span class="vs-radio--circle"></span>
                                                                </span>
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="status" @if($quiz->status == 'لغو شده') checked @endif value="لغو شده">
                                                                <span class="vs-radio vs-radio-lg">
                                                                    <span class="vs-radio--border"></span>
                                                                    <span class="vs-radio--circle"></span>
                                                                </span>
