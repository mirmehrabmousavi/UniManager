    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">ویرایش بازاریاب</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">خانه</a></li>
                            <li class="breadcrumb-item active">ویرایش بازاریاب</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ویرایش بازاریاب</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('marketer.update', [$marketer->id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('name') is-invalid @enderror"
                                                           name="name" value="{{$marketer->name}}" required>
                                                </div>
                                                @error('name')
                                            ...
                                            <div class="col-12"><label for="marketer-name">نوع بازاریاب</label>
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="type" @if($marketer->type == 'collegian') checked @endif value="false">
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="type" @if($marketer->type == 'marketer') checked @endif value="false">
                                                                <span class="vs-radio vs-radio-lg">
                                                                    <span class="vs-radio--border"></span>
                                                                    <span class="vs-radio--circle"></span>
                                                                </span>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('number') is-invalid @enderror"
                                                           name="number" value="{{$marketer->number}}" required>
                                                </div>
                                                @error('number')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('address') is-invalid @enderror"
                                                           name="address" value="{{$marketer->address}}" required>
                                                </div>
                                                @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('melli_code') is-invalid @enderror"
                                                           name="melli_code"  value="{{$marketer->melli_code}}" required>
                                                </div>
                                                @error('melli_code')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('static_number') is-invalid @enderror"
                                                           name="static_number" value="{{$marketer->static_number}}" required>
                                                </div>
                                                @error('static_number')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('known_number') is-invalid @enderror"
                                                           name="known_number" value="{{$marketer->known_number}}" required>
                                                </div>
                                                @error('known_number')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
