    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">ویرایش زیرمجموعه</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">خانه</a></li>
                            <li class="breadcrumb-item active">ویرایش زیرمجموعه</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ویرایش زیرمجموعه</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('subclass.update', [$subclass->id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="marketer-name" class="form-control @error('marketer') is-invalid @enderror"
                                                        ...
                                                        @if($marketer)
                                                            @if($subclass->marketer == 'null')
                                                                <option value="null">بدون بازاریاب</option>
                                                            @endif
                                                            @foreach($marketer as $item)
                                                                <option value="{{$item->name}}" @if($item->name == $subclass->marketer) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        @else
                                                            @if($subclass->marketer == 'null')
                                                                <option value="null">بدون بازاریاب</option>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="marketer-name" class="form-control @error('idd_subclass') is-invalid @enderror"
                                                           name="idd_subclass" value="{{$subclass->idd_subclass}}" required>
                                                </div>
                                                @error('idd_subclass')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="marketer-name" class="form-control @error('full_name_subclass') is-invalid @enderror"
                                                           name="full_name_subclass" value="{{$subclass->full_name_subclass}}" required>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="marketer-name" class="form-control @error('date') is-invalid @enderror"
                                                           name="date" value="{{$subclass->date}}" required>
                                                </div>
                                                @error('date')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <ul class="list-unstyled mb-2">
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="paid"  @if($subclass->paid == 'paid') checked @endif value="paid">
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="vs-radio-con vs-radio-primary">
                                                                <input type="radio" name="paid" @if($subclass->paid == 'unpaid') checked @endif value="unpaid">
                                                                <span class="vs-radio vs-radio-lg">
                                                                    <span class="vs-radio--border"></span>
                                                                    <span class="vs-radio--circle"></span>
                                                                </span>
